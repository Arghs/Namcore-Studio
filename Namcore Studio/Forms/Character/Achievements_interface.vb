...
Public Class Achievements_interface
    ...
    Dim tmpSender As Object
    Dim m_event As EventArgs
    Dim state As String
        ...
        Try
            ...
            For Each charAv As Achievement In currentViewedCharSet.Achievements
                ...
                If correctIds.Contains(charAv.Id) Then
                    LogAppend("Operating next av / operation_count is:" & operation_count.ToString(), "Achievements_continueOperation", False)
            ...
            Else
                ...
                Try
                    ...
                    Else
                        AVLayoutPanel.Controls(AVLayoutPanel.Controls.Count - 1).BackColor = Color.FromArgb(110, 149, 190)
                    End If
                Catch ex As Exception
    ...
    Private Sub add_bt_Click(sender As Object, e As EventArgs) Handles add_bt.Click
        ...
        If trdRunning > 0 Then
            ...
            Exit Sub
        End If
        If current_cat = Nothing Then Exit Sub
