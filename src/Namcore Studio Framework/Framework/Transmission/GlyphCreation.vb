    ...
    Public Class GlyphCreation
        ...
        Private Sub CreateAtArcemu(ByVal characterguid As Integer, ByVal targetSetId As Integer,
            ...
            glyphstring1 = glyphstring1.Replace("minor1",
                                                (GetGlyphIdByItemId(GetCharacterGlyph(player, "minorglyph1").Id,
                                                                    GlobalVariables.targetExpansion).ToString))
            glyphstring1 = glyphstring1.Replace("minor2",
                                                (GetGlyphIdByItemId(GetCharacterGlyph(player, "minorglyph2").Id,
                                                                    GlobalVariables.targetExpansion).ToString))
            glyphstring1 = glyphstring1.Replace("minor3",
                                                (GetGlyphIdByItemId(GetCharacterGlyph(player, "minorglyph3").Id,
                                                                    GlobalVariables.targetExpansion).ToString))
            glyphstring1 = glyphstring1.Replace("major1",
                                                (GetGlyphIdByItemId(GetCharacterGlyph(player, "majorglyph1").Id,
                                                                    GlobalVariables.targetExpansion).ToString))
            glyphstring1 = glyphstring1.Replace("major2",
                                                (GetGlyphIdByItemId(GetCharacterGlyph(player, "majorglyph2").Id,
                                                                    GlobalVariables.targetExpansion).ToString))
            glyphstring1 = glyphstring1.Replace("major3",
                                                (GetGlyphIdByItemId(GetCharacterGlyph(player, "majorglyph3").Id,
                                                                    GlobalVariables.targetExpansion).ToString))
            glyphstring2 = glyphstring2.Replace("minor1",
                                                (GetGlyphIdByItemId(GetCharacterGlyph(player, "secminorglyph1").Id,
                                                                    GlobalVariables.targetExpansion).ToString))
            glyphstring2 = glyphstring2.Replace("minor2",
                                                (GetGlyphIdByItemId(GetCharacterGlyph(player, "secminorglyph2").Id,
                                                                    GlobalVariables.targetExpansion).ToString))
            glyphstring2 = glyphstring2.Replace("minor3",
                                                (GetGlyphIdByItemId(GetCharacterGlyph(player, "secminorglyph3").Id,
                                                                    GlobalVariables.targetExpansion).ToString))
            glyphstring2 = glyphstring2.Replace("major1",
                                                (GetGlyphIdByItemId(GetCharacterGlyph(player, "secmajorglyph1").Id,
                                                                    GlobalVariables.targetExpansion).ToString))
            glyphstring2 = glyphstring2.Replace("major2",
                                                (GetGlyphIdByItemId(GetCharacterGlyph(player, "secmajorglyph2").Id,
                                                                    GlobalVariables.targetExpansion).ToString))
            glyphstring2 = glyphstring2.Replace("major3",
                                                (GetGlyphIdByItemId(GetCharacterGlyph(player, "secmajorglyph3").Id,
                                                                    GlobalVariables.targetExpansion).ToString))
            runSQLCommand_characters_string(
        ...
        Private Sub CreateAtTrinity(ByVal characterguid As Integer, ByVal targetSetId As Integer,
            ...
            If GlobalVariables.targetExpansion = 4 Then
                runSQLCommand_characters_string(
                    ...
                    "', '0', '" &
                    (GetGlyphIdByItemId(GetCharacterGlyph(player, "majorglyph1").Id, GlobalVariables.targetExpansion)).
                        ToString & "', " &
                    "'" &
                    (GetGlyphIdByItemId(GetCharacterGlyph(player, "minorglyph2").Id, GlobalVariables.targetExpansion)).
                        ToString & "', " &
                    "'" &
                    (GetGlyphIdByItemId(GetCharacterGlyph(player, "minorglyph3").Id, GlobalVariables.targetExpansion)).
                        ToString & "', " &
                    "'" &
                    (GetGlyphIdByItemId(GetCharacterGlyph(player, "majorglyph2").Id, GlobalVariables.targetExpansion)).
                        ToString & "', " &
                    "'" &
                    (GetGlyphIdByItemId(GetCharacterGlyph(player, "minorglyph1").Id, GlobalVariables.targetExpansion)).
                        ToString & "', " &
                    "'" &
                    (GetGlyphIdByItemId(GetCharacterGlyph(player, "majorglyph3").Id, GlobalVariables.targetExpansion)).
                        ToString & "', " &
                    "'" &
                    (GetGlyphIdByItemId(GetCharacterGlyph(player, "primeglyph1").Id, GlobalVariables.targetExpansion)).
                        ToString & "', " &
                    "'" &
                    (GetGlyphIdByItemId(GetCharacterGlyph(player, "primeglyph2").Id, GlobalVariables.targetExpansion)).
                        ToString & "', " &
                    "'" &
                    (GetGlyphIdByItemId(GetCharacterGlyph(player, "primeglyph3").Id, GlobalVariables.targetExpansion)).
                        ToString & "' )", True)
                runSQLCommand_characters_string(
                    "INSERT INTO " & GlobalVariables.targetStructure.character_glyphs_tbl(0) & " ( " &
                    GlobalVariables.targetStructure.glyphs_guid_col(0) & ", " &
                    ...
                    characterguid.ToString() &
                    "', '1', '" &
                    (GetGlyphIdByItemId(GetCharacterGlyph(player, "secmajorglyph1").Id, GlobalVariables.targetExpansion)) _
                        .ToString & "', " &
                    "'" &
                    (GetGlyphIdByItemId(GetCharacterGlyph(player, "secminorglyph2").Id, GlobalVariables.targetExpansion)) _
                        .ToString & "', " &
                    "'" &
                    (GetGlyphIdByItemId(GetCharacterGlyph(player, "secminorglyph3").Id, GlobalVariables.targetExpansion)) _
                        .ToString & "', " &
                    "'" &
                    (GetGlyphIdByItemId(GetCharacterGlyph(player, "secmajorglyph2").Id, GlobalVariables.targetExpansion)) _
                        .ToString & "', " &
                    "'" &
                    (GetGlyphIdByItemId(GetCharacterGlyph(player, "secminorglyph1").Id, GlobalVariables.targetExpansion)) _
                        .ToString & "', " &
                    "'" &
                    (GetGlyphIdByItemId(GetCharacterGlyph(player, "secmajorglyph3").Id, GlobalVariables.targetExpansion)) _
                        .ToString & "', " &
                    "'" &
                    (GetGlyphIdByItemId(GetCharacterGlyph(player, "secprimeglyph1").Id, GlobalVariables.targetExpansion)) _
                        .ToString & "', " &
                    "'" &
                    (GetGlyphIdByItemId(GetCharacterGlyph(player, "secprimeglyph2").Id, GlobalVariables.targetExpansion)) _
                        .ToString & "', " &
                    "'" &
                    (GetGlyphIdByItemId(GetCharacterGlyph(player, "secprimeglyph3").Id, GlobalVariables.targetExpansion)) _
                        .ToString & "' )", True)
        ...
        Private Sub CreateAtMangos(ByVal characterguid As Integer, ByVal targetSetId As Integer,
            ...
            runSQLCommand_characters_string(
                ...
                GlobalVariables.targetStructure.glyphs_glyph_col(0) & " ) VALUES ( '" & characterguid.ToString() &
                "', '1', '4', '" &
                (GetGlyphIdByItemId(GetCharacterGlyph(player, "secminorglyph1").Id, GlobalVariables.targetExpansion)).
                    ToString() & "' )", True)
            runSQLCommand_characters_string(
                "INSERT INTO " & GlobalVariables.targetStructure.character_glyphs_tbl(0) & " ( " &
                GlobalVariables.targetStructure.glyphs_guid_col(0) & ", " &
                ...
                GlobalVariables.targetStructure.glyphs_glyph_col(0) & " ) VALUES ( '" & characterguid.ToString() &
                "', '1', '1', '" &
                (GetGlyphIdByItemId(GetCharacterGlyph(player, "secminorglyph2").Id, GlobalVariables.targetExpansion)).
                    ToString() & "' )", True)
            runSQLCommand_characters_string(
                "INSERT INTO " & GlobalVariables.targetStructure.character_glyphs_tbl(0) & " ( " &
                GlobalVariables.targetStructure.glyphs_guid_col(0) & ", " &
                ...
                GlobalVariables.targetStructure.glyphs_glyph_col(0) & " ) VALUES ( '" & characterguid.ToString() &
                "', '1', '2', '" &
                (GetGlyphIdByItemId(GetCharacterGlyph(player, "secminorglyph3").Id, GlobalVariables.targetExpansion)).
                    ToString() & "' )", True)
            runSQLCommand_characters_string(
                "INSERT INTO " & GlobalVariables.targetStructure.character_glyphs_tbl(0) & " ( " &
                GlobalVariables.targetStructure.glyphs_guid_col(0) & ", " &
                ...
                GlobalVariables.targetStructure.glyphs_glyph_col(0) & " ) VALUES ( '" & characterguid.ToString() &
                "', '1', '0', '" &
                (GetGlyphIdByItemId(GetCharacterGlyph(player, "secmajorglyph1").Id, GlobalVariables.targetExpansion)).
                    ToString() & "' )", True)
            runSQLCommand_characters_string(
                "INSERT INTO " & GlobalVariables.targetStructure.character_glyphs_tbl(0) & " ( " &
                GlobalVariables.targetStructure.glyphs_guid_col(0) & ", " &
                ...
                GlobalVariables.targetStructure.glyphs_glyph_col(0) & " ) VALUES ( '" & characterguid.ToString() &
                "', '1', '3', '" &
                (GetGlyphIdByItemId(GetCharacterGlyph(player, "secmajorglyph2").Id, GlobalVariables.targetExpansion)).
                    ToString() & "' )", True)
            runSQLCommand_characters_string(
                "INSERT INTO " & GlobalVariables.targetStructure.character_glyphs_tbl(0) & " ( " &
                GlobalVariables.targetStructure.glyphs_guid_col(0) & ", " &
                ...
                GlobalVariables.targetStructure.glyphs_glyph_col(0) & " ) VALUES ( '" & characterguid.ToString() &
                "', '1', '5', '" &
                (GetGlyphIdByItemId(GetCharacterGlyph(player, "secmajorglyph3").Id, GlobalVariables.targetExpansion)).
                    ToString() & "' )", True)
            If GlobalVariables.targetExpansion = 4 Then
                runSQLCommand_characters_string(
                    "INSERT INTO " & GlobalVariables.targetStructure.character_glyphs_tbl(0) & " ( " &
